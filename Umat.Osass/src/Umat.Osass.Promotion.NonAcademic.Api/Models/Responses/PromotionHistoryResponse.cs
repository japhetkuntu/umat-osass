...
public class PromotionHistoryResponse
{
    ...
    public NonAcademicApplicationPerformance? Performance { get; set; }
    public string? PromotionLetterUrl { get; set; }
}

public class NonAcademicApplicationPerformance
{
    public string PerformanceAtWork { get; set; } = string.Empty;
    public string KnowledgeProfession { get; set; } = string.Empty;
