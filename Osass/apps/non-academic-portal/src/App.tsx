...
const PerformanceAtWorkSection = lazy(() => import("./pages/PerformanceAtWorkSection"));
const KnowledgeProfessionSection = lazy(() => import("./pages/KnowledgeProfessionSection"));
                    ...
                    <RootLayout>
                      <Suspense fallback={<PageLoader />}>
                        <Routes>
                          ...
                          <Route path="/application/performance" element={<PerformanceAtWorkSection />} />
                          <Route path="/application/knowledge" element={<KnowledgeProfessionSection />} />
