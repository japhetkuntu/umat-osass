  ...
  useEffect(() => {
    const fetchLetter = async () => {
      ...
      try {
        ...
        const res = await nonAcademicService.getPromotionLetter(applicationId);
          ...
          <div className="mb-6 text-sm">
            ...
            <div className="space-y-4 text-justify text-sm leading-7">
              ...
              <div className="performance-box bg-muted/30 p-4 rounded-lg border border-border my-4">
                ...
                <div className="performance-grid grid grid-cols-3 gap-4 text-sm">
                  <div className="performance-item text-center">
                    <div className="performance-label text-muted-foreground">Performance at Work</div>
                    <div className="performance-value font-semibold text-primary text-lg">{letterData.performanceAtWorkPerformance}</div>
                  </div>
                  <div className="performance-item text-center">
                    <div className="performance-label text-muted-foreground">Knowledge & Profession</div>
                    <div className="performance-value font-semibold text-secondary text-lg">{letterData.knowledgeProfessionPerformance}</div>
                  </div>
                  <div className="performance-item text-center">
              ...
              <p className="body-text">
                ...
                evaluated dimensions. Specifically, your contributions in performance at work, knowledge & profession, and
              ...
              <p className="body-text">
                We express our sincere appreciation for your dedicated service and your contributions to the
                excellence and development of the University of Mines and Technology. Your promotion reflects the
                University's commitment to recognizing and rewarding outstanding professional performance and leadership.
              </p>
