...
import { BarChart3, BookOpen, Users, Clock, ArrowRight, Lock, Rocket, CheckCircle2, FileText, Shield } from "lucide-react";
...
const Application = () => {
  ...
  const applicationStarted = !!(appState?.applicationId);

  const handleStartApplication = async () => {
    setIsStarting(true);
    try {
      const res = await nonAcademicService.startApplication();
      if (res.success) {
        setAppState(res.data);
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        {/* Section Cards */}
        <div className="md:col-span-8 lg:col-span-9 space-y-6">
          <RequiredDocumentsCard applicationStatus={appState?.applicationStatus} locked={!applicationStarted} />
        ...
        <DialogContent className="sm:max-w-lg p-0 overflow-hidden gap-0">
          ...
          <div className="px-8 -mt-4 relative z-10">
            <div className="flex flex-wrap gap-2">
              {[
                { icon: BarChart3, label: "Performance at Work" },
                { icon: BookOpen, label: "Knowledge & Profession" },
