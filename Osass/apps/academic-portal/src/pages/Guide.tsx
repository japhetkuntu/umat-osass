  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <section className="flex items-center justify-between border-b border-border pb-6 print:hidden">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            A complete walkthrough of the OSASS Teaching Staff Portal features.
          </p>
        </div>
      ...
      <div className="hidden print:block mb-6">
        <h1 className="text-2xl font-bold">OSASS — Teaching Staff Portal: User Guide</h1>
      ...
      >
        <p>
          The OSASS Teaching Staff Portal is your self-service platform for applying for teaching staff
      ...
      >
        ...
        <ul>
          <li>Years spent in your current rank</li>
          <li>Minimum publication count and impact-factor thresholds</li>
          <li>Teaching load requirements</li>
      ...
      >
        <p>
          ...
          remaining career progression, not just the next step. For each future rank you will
          see:
        </p>
        <ul>
          <li><strong>Projected eligibility year</strong> — based on current rank date and minimum years required.</li>
          <li><strong>Performance criteria thresholds</strong> — the score levels set by the university for that rank.</li>
          <li><strong>Publications already counted</strong> — only publications you have uploaded toward that specific target position are included, so the data is isolated per milestone.</li>
        </ul>
        <p>
      ...
      >
        ...
        <h3>Teaching{' '}
          <Link to="/application/teaching" className="text-primary text-xs font-normal underline underline-offset-2 print:hidden">→ Go to Teaching</Link>
        </h3>
        <p>
          Upload your teaching load records for the review period. Provide course codes, credit
          hours, and student numbers. The system validates that the totals meet the minimum
          contact-hour requirement for your target rank.
        </p>

        <h3>Publications{' '}
          <Link to="/application/publications" className="text-primary text-xs font-normal underline underline-offset-2 print:hidden">→ Go to Publications</Link>
        </h3>
        <p>
          Add each publication with its title, journal, publication year, and category. You can attach
          a PDF or link as evidence. If you <strong>presented</strong> the work at a recognised conference
          or forum, tick the <em>"Presented at Conference / Forum?"</em> checkbox and enter the venue
          name — this grants an additional <strong>+2 bonus points</strong> for that publication.
          The system scores each publication against the type's baseline and only counts publications
          submitted under <em>this specific application</em> toward your eligibility.
        </p>
        <p>
        ...
        <p>
          ...
          appropriate committee (DAPC → FAPSC → UAPC) based on your department.
        </p>
      </GuideSection>
      ...
      <div className="border-t border-border pt-6 text-xs text-muted-foreground">
        <p>
          ...
          queries, contact your Faculty Teaching Staff Promotions Sub-Committee (FAPSC) coordinator.
        </p>
      </div>
