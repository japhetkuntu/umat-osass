        ...
        <div className="card-elevated p-6 mb-6 animate-slide-up" style={{ animationDelay: "100ms" }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{data.publications.length} records found</p>
            </div>
          </div>

          <div className="space-y-4">
            {data.publications.length === 0 ? (
              <p className="text-sm text-muted-foreground italic py-4">No publication records submitted.</p>
              ...
              >
                ...
                <div className="flex gap-6 text-sm">
                  <div>
                    ...
                    <span className="font-medium text-foreground">{pub.score}</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground text-xs uppercase font-bold tracking-tighter">Verified: </span>
                    <span className="font-medium text-primary">{pub.applicantScore}</span>
                  </div>
                </div>
              </div>
            ))}
