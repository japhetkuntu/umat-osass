...
const EligibilityGuidance = () => {
  ...
  const guidanceItems = [
    {
      icon: GraduationCap,
      title: "Prepare Your Teaching Evidence",
      description: "Begin organizing materials related to the 10 teaching categories so you're ready when eligible. Consider documenting innovations, student feedback, and supervision activities.",
    },
    {
      icon: BookOpen,
      title: "Organize Your Publications",
      description: "Keep records of publications and supporting documents as they are produced. Maintain a log of journal articles, conference papers, and other scholarly work.",
    },
    {
      icon: Users,
      ...
      <main className="content-container">
        ...
        <div className="text-center mb-10 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            You're making progress in your academic career. At this time, you're not yet eligible to apply for promotion based on time in your current position.
          </p>
        </div>
