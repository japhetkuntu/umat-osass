    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (res.success) {
          ...
          toast.error(res.message || "Failed to load academic state");
        }
      } catch (error) {
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card-elevated p-6 sm:p-8 space-y-6">
              <div className="space-y-2">
                <h2 className="text-lg font-serif font-semibold text-foreground flex items-center gap-2">
                  ...
                  <HelpTip tip="Track your current promotion application. Submit teaching, publication, and service records for committee review." />
                </h2>
            ...
            <div className="card-elevated p-6 sm:p-8 space-y-6">
              <div className="space-y-2">
                <h2 className="text-lg font-serif font-semibold text-foreground flex items-center gap-2">
                  Performance Summary
                  <HelpTip tip="A summary of your uploaded evidence across teaching, publications, and service — the three categories evaluated for promotion." />
                </h2>
                <p className="text-sm text-muted-foreground">Current assessment across academic categories</p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card-elevated p-6 space-y-4">
              ...
              <nav className="space-y-2">
                ...
                <button
                  ...
                  className="w-full text-left py-2.5 px-3 rounded text-sm font-medium text-foreground hover:bg-muted transition-colors flex items-center justify-between group"
                >
                  <span>Publication Score Guide</span>
                  <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
                </button>
                <button
            ...
            <div className="card-elevated p-6 space-y-4 border-dashed border-2">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Contact the Teaching Staff Promotion Office</p>
              </div>
              <Button
                variant="outline"
