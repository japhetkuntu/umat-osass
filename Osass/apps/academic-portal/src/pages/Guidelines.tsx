                    ...
                    <section className="space-y-6">
                        ...
                        <div className="card-elevated p-8 space-y-4">
                            <div className="flex gap-4 p-4 bg-muted/30 rounded-xl">
                                ...
                                <p className="text-sm">
                                    Minimum of {requirement?.minimumNumberOfYearsFromLastPromotion || 4} years of continuous service as a {requirement?.previousPosition || 'Lecturer'}.
                                </p>
                            </div>
                            <div className="flex gap-4 p-4 bg-muted/30 rounded-xl">
                                <CheckCircle2 className="w-5 h-5 text-success shrink-0" />
                                <p className="text-sm">
                                    Must have at least {requirement?.minimumNumberOfPublications || 0} publications total, with {requirement?.minimumNumberOfRefereedJournal || 0} being refereed journals.
                                </p>
                            </div>
                            <div className="flex gap-4 p-4 bg-muted/30 rounded-xl">
                                <CheckCircle2 className="w-5 h-5 text-success shrink-0" />
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <p className="text-sm text-muted-foreground leading-relaxed italic">
                                Advancement is determined by the combination of assessment levels across Teaching, Research, and Service. Below are the minimum requirements per rank:
                            </p>

                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    { rank: "Senior Lecturer", combinations: ["2 Highs + 1 Adequate", "3 Goods"] },
                                    { rank: "Associate Professor", combinations: ["2 Highs + 1 Good"] },
                                    { rank: "Professor", combinations: ["3 Highs"] },
                                ].map((rankItem) => (
