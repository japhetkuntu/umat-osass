  ...
  useEffect(() => {
    const fetchPromotionHistory = async () => {
      try {
        setLoading(true);
        setError(null);
        const response = await academicService.getPromotionHistory();
              ...
              >
                ...
                <div className={cn(
                  ...
                  <div className="p-6 sm:p-8 space-y-6 bg-white">
                    ...
                    {app.applicationStatus === 'Approved' && (
                      <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 animate-in fade-in duration-500">
                    ...
                    {app.applicationStatus.toLowerCase() === 'returned' && (
                      <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 animate-in fade-in duration-500">
                        <div className="flex items-start gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Teaching Performance</span>
                            </div>
                            <div className="text-xl font-black text-foreground">{app.performance?.teaching || "—"}</div>
                          </div>
                          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                            <div className="flex items-center gap-2 mb-2">
                              <TrendingUp className="w-3.5 h-3.5 text-secondary" />
                              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Publication Performance</span>
                            </div>
                            <div className="text-xl font-black text-foreground">{app.performance?.publication || "—"}</div>
                          </div>
                          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                            <div className="flex items-center gap-2 mb-2">
